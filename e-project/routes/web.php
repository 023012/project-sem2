...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['prefix' => '/product-comments'], function () {
        ...
        Route::get('/{product-comments}/edit', [\App\Http\Controllers\Admin\ProductCommentsController::class, 'edit'])->name('admin.product-comments.edit');
        Route::put('/{product-comments}/update', [\App\Http\Controllers\Admin\ProductCommentsController::class, 'update'])->name('admin.product-comments.update');
        Route::delete('/{product-comments}/delete', [\App\Http\Controllers\Admin\ProductCommentsController::class, 'destroy'])->name('admin.product-comments.destroy');
    });
      //product
