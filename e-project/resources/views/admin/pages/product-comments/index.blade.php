              ...
              <div class="card shadow">
                <div class="card-body">
                  ...
                  <table class="table datatables" id="tbl">
                    ...
                    <tbody>
                      @foreach ($product_comments as $ProductComments)
                          <tr>
                              ...
                              <td>
                                  <form method="POST" action="{{ route('admin.product-comments.destroy', $ProductComments->id) }}">
                                      @csrf
                                      @method('DELETE')
                                      <a href="{{ route('admin.product-comments.edit', $ProductComments->id) }}" class="btn" onclick="handleEdit()"><span
