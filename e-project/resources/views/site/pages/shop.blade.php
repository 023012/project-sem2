                                                    ...
                                                    <div class="product-list-single product-color--golden">
                                                        <a href="{{route('site.product_details_default')}}"
                                                            ...
                                                            <img class="img-fluid"
                                                                ...
                                                                alt="">
                                                            <img class="img-fluid"
                                                                src="{{asset('frontend/assets/images/product/default/home-1/default-4.jpg')}}"
                                                                alt="">
                                                        </a>
                                                        <div class="product-list-content">
                                                            <h5 class="product-list-link"><a
                                                    ...
                                                    <div class="product-list-single product-color--golden">
                                                        <a href="{{route('site.product_details_default')}}"
                                                            ...
                                                            <img class="img-fluid"
                                                                ...
                                                                alt="">
                                                            <img class="img-fluid"
                                                                src="{{asset('frontend/assets/images/product/default/home-1/default-6.jpg')}}"
                                                                alt="">
                                                        </a>
                                                        <div class="product-list-content">
                                                            <h5 class="product-list-link"><a
                                                    ...
                                                    <div class="product-list-single product-color--golden">
                                                        <a href="{{route('site.product_details_default')}}"
                                                            ...
                                                            <img class="img-fluid"
                                                                ...
                                                                alt="">
                                                            <img class="img-fluid"
                                                                src="{{asset('frontend/assets/images/product/default/home-1/default-8.jpg')}}"
                                                                alt="">
                                                        </a>
                                                        <div class="product-list-content">
                                                            <h5 class="product-list-link"><a
